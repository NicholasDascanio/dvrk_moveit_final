...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def __init__(self):
    ...
    group_name = "psm1_arm"
    #end_eff = "psm1_gripper"
    #full_arm = "psm1_full"
    move_group = moveit_commander.MoveGroupCommander(group_name)
    #move_end = moveit_commander.MoveGroupCommander(end_eff)
    #move_all = moveit_commander.MoveGroupCommander(full_arm)
    ...
    #eef1_link = move_end.get_end_effector_link()
    #eef2_link = move_all.get_end_effector_link()
    print "============ End effector link 1: %s" % eef_link
    #print "============ End effector link 2: %s" % eef1_link
    #print "============ End effector link 3: %s" % eef2_link
  ...
  def go_to_joint_state(self):
    ...
    #joint_goal[9] = joint_goal[9] + 0.4
    #joint_goal[10] = joint_goal[10] + 0.1
    print(joint_goal)
  ...
  def go_to_pose_goal(self):
    ...
    #pose_prova.position.x= 0.00170709527587
    #pose_prova.position.y= -0.00286801174805
    #pose_prova.position.z= 0.00551932434075
    
    #pose_prova.orientation.x= -0.471727742368
    #pose_prova.orientation.y= 0.286479455737
    #pose_prova.orientation.z= 0.149740619118
    #pose_prova.orientation.w= 0.82035370756
    ...
    #pose_goal.position.x = pose_goal.position.x + 0.0003
    pose_goal.position.y = pose_goal.position.y + 0.1
    #pose_goal.position.z = pose_goal.position.z + 0.0002
    print(pose_goal)
    ...
    print(plan[1].joint_trajectory.points) #posizioni, velocita e accellerazioni dei 7 joints nei vari momenti piu il tempo trascorso
    print('UEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE')
    ...
    print('UAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA')
