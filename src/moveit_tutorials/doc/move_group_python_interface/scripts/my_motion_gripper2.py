...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def go_to_pose_goal(self):
    ...
    #pose_prova = move_group.get_random_pose().pose
    ...
    #set_max_velocity_scaling_factor(self, value)
    #set_max_acceleration_scaling_factor(self, value)
  ...
  def plan_cartesian_path(self, scale=1):
    ...
    #print(plan.joint_trajectory.points) # posizioni dei 7 joints nel momento iniziale
    #print(plan.multi_dof_joint_trajectory)
    #print(fraction)
