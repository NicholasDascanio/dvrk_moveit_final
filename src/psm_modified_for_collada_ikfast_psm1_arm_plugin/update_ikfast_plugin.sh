...
moveit_config_pkg=dvrk_gripper2
...
ikfast_output_path=/home/dvrk-lite/ws_moveit_test/src/psm_modified_for_collada_ikfast_psm1_arm_plugin/src/psm_modified_for_collada_psm1_arm_ikfast_solver.cpp
