# Install script for directory: /home/dvrk-lite/ws_moveit_test/src/openrave/octave_matlab/octave
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "openrave0.9-dp-octave")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/openrave-0.9/octave" TYPE FILE FILES "/home/dvrk-lite/ws_moveit_test/src/openrave/build/octave_matlab/octave/orcreate.mex")
endif()

if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "openrave0.9-dp-octave")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/openrave-0.9/octave" TYPE FILE FILES "/home/dvrk-lite/ws_moveit_test/src/openrave/build/octave_matlab/octave/orread.mex")
endif()

if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "openrave0.9-dp-octave")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/openrave-0.9/octave" TYPE FILE FILES "/home/dvrk-lite/ws_moveit_test/src/openrave/build/octave_matlab/octave/orwrite.mex")
endif()

if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "openrave0.9-dp-octave")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/openrave-0.9/octave" TYPE FILE FILES
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "openrave0.9-dp-octave")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/openrave-0.9/octave" TYPE DIRECTORY FILES "/home/dvrk-lite/ws_moveit_test/src/openrave/octave_matlab/examples" REGEX "/\\.svn$" EXCLUDE)
endif()
